...
public interface Bridge<I extends SequenceElement, O extends SequenceElement> {
	...
	public boolean sendSource(I input, O output, Input<I> in, Output<O> out)  throws InterruptedException;
	
	public static class DefaultBridge<S extends SequenceElement, Q extends SequenceElement> implements Bridge<S, Q> {

		public boolean sendSource(S source, Q output, Input<S> in, Output<Q> out) throws InterruptedException {
