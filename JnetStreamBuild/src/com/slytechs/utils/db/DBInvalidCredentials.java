...
/**
 * Either a user name or password is invalid inorder to establish connectivity 
 * to the database.
 * 
 * @author Mark Bednarczyk
 * @authro Sly Technologies, Inc.
 */
public class DBInvalidCredentials extends DBSimpleException {
	 ...
	 */
	public DBInvalidCredentials(DBProperties dbProperties, String msg) {
	 ...
	 */
	public DBInvalidCredentials(DBProperties dbProperties, String msg, SQLException cause) {
