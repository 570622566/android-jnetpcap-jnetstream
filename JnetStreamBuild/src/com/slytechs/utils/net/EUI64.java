...
public class EUI64 
	 ...
	 * @return
	 */
	public static EUI64 valueOf(String address) {
		return new EUI64(address);
	}
	 ...
	 * @return
	 */
	public static EUI64 valueOf(Long address) {
		return new EUI64(AddressUtils.toByteArray6Bytes(address));
	}
