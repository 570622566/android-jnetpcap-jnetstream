 ...
 * </UL>
 * 
 * @param <S> type for all setter operations
 * @param <R> type for all remove operations
 * 
...
public interface FileModifier<S, R> extends IOAddable<S>, IORemovable {
	 ...
	 *           any IO errors
	 */
	public void addAll(List<S> elements) throws IOException;

	/**
	 * Adds an array of list at the current location in the order they appear in
	 * the array.
	 * 
	 * @param elements
	 ...
	 *           any IO errors
	 */
	public void addAll(S... elements) throws IOException;
	 ...
	 *           any IO errors
	 */
	public void removeAll(long count) throws IOException;
	...
	/**
	 * Replaces the current element with the new element specified. If the element
	 ...
	 *           any IO errors
	 */
	public void replace(S element) throws IOException;

	/**
	 * <p>
	 * Bulk remove, that removes all records other then the ones found in the
	 * list. The records that are part of the list, must have been
