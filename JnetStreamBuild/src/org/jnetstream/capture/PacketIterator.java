 ...
 */
public interface PacketIterator<I extends CapturePacket> extends
    FileIterator<I, Packet, I> {
	/*
	 ...
	 *           any IO errors
	 */
	public void add(ByteBuffer data, Protocol dlt, long original,
	 ...
	 *           any IO errors
	 */
	public void add(ByteBuffer data, int dlt, long original, long seconds,
	 ...
	 *           any IO errors
	 */
	public void add(ByteBuffer data, Protocol dlt) throws IOException;
	 ...
	 *           any IO errors
	 */
	public void add(ByteBuffer data) throws IOException;
}
