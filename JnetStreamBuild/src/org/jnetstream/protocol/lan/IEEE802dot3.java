...
public interface IEEE802dot3 extends Header {
	...
	public interface Destination extends Field<EUI48> {
		...
		public final static String VALUE_DESCRIPTION = "";

		public final static String VALUE_UNITS = "MAC address";
	...
	public final static String NAME = "IEEE802dot3";
	...
	public <T> T getProperty(IEEE802dot3.DynamicProperty property);

	public <T> T getProperty(IEEE802dot3.StaticProperty property);
